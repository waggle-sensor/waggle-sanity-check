...
def main():
    ...
    totalInteractiveTests, numberOfInteractiveTestsFailed, interactiveTestsFailed = execute_tests_in_path(sanity_config.interactive_tests, "interactive")
        
    logging.info("Interactive Tests Complete\n")

    logging.info("Test Resuslts:")
    logging.info(f"Interactive [{totalNumInteractiveTests-numberOfInteractiveTestsFailed} | {totalNumInteractiveTests}]: {str(interactiveTestsFailed)}")
